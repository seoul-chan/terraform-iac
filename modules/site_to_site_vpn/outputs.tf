...
output "vpn_connection_tunnel1_cgw_inside_address" {
  ...
  value = try(
    aws_vpn_connection.this[0].tunnel1_cgw_inside_address,
  "")
}
...
output "vpn_connection_tunnel1_vgw_inside_address" {
  ...
  value = try(
    aws_vpn_connection.this[0].tunnel1_vgw_inside_address,
  "")
}
...
output "vpn_connection_tunnel2_cgw_inside_address" {
  ...
  value = try(
    aws_vpn_connection.this[0].tunnel2_cgw_inside_address,
  "")
}
...
output "vpn_connection_tunnel2_vgw_inside_address" {
  ...
  value = try(
    aws_vpn_connection.this[0].tunnel2_vgw_inside_address,
  "")
}
...
output "vpn_connection_transit_gateway_attachment_id" {
  ...
  value = try(
    aws_vpn_connection.this[0].transit_gateway_attachment_id,
  "")
}
...
output "vpn_connection_customer_gateway_configuration" {
  ...
  value = try(
    aws_vpn_connection.this[0].customer_gateway_configuration,
  "")
  sensitive = true
}
...
output "tunnel1_preshared_key" {
  ...
  value = try(
    aws_vpn_connection.this[0].tunnel1_preshared_key,
  "")
  sensitive = true
}
...
output "tunnel2_preshared_key" {
  ...
  value = try(
    aws_vpn_connection.this[0].tunnel2_preshared_key,
  "")
  sensitive = true
}
